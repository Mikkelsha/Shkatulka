...
RNGkind("L'Ecuyer-CMRG")
set.seed(1)
bag.boston=randomForest(medv~.,data=Boston,subset=train,mtry=13,importance=TRUE) #using all 13 predictors 
bag.boston
...
# [1] 15.53946
# Random Forest yielded an improvement over bagging
...
# [1] 15.83297 (MSE) similar to Random forest


boost.boston=gbm(medv~.,data=Boston[train,],distribution="gaussian",n.trees=5000,interaction.depth=4,shrinkage=0.2,verbose=F)
#interaction.depth = number of splits in each tree 
# shrinkage = alpha, the rate aat which the algorithm learns)
